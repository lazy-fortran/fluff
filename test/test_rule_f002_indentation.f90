...
contains
    ...
    subroutine test_inconsistent_indentation()
        ...
        print *, "  ⚠ Inconsistent indentation (skipped - fortfront not available)"
        return
    ...
    subroutine test_consistent_4_spaces()
        ...
        ! Skip test if fortfront not available
        print *, "  ⚠ Consistent 4-space indentation (skipped - fortfront not available)"
        return
    ...
    subroutine test_consistent_2_spaces()
        ! Skip test if fortfront not available
        print *, "  ⚠ Consistent 2-space indentation (skipped - fortfront not available)"
    end subroutine test_consistent_2_spaces
    
    subroutine test_mixed_levels()
        ! Skip test if fortfront not available
        print *, "  ⚠ Mixed indentation levels (skipped - fortfront not available)"
